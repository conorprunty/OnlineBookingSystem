		...
		<form action="userSelectRest.php" name="userChoice" method="post" class="setupForm" align="center" >
			<div class="row">
				...
				<div class="col-6 col-md-4" style="padding-left:25px;">
					...
					<ul style = "float:left;">
						<li>
							<input type="checkbox" name="title" id="title_1" /> <label for="title_1"><strong>All Early</strong></label>
							<ul>
					...
					<ul style = "float:left;">
						<li>
							<input type="checkbox" name="title" id="title_2" /> <label for="title_2"><strong>All Late</strong></label>
							<ul>
