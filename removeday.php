...
if (empty($_SESSION['user'])) {
    ...
    //selecting all days available from the area chosen
    session_start();
    $name  = $_SESSION['name'];
    $query = " 
            SELECT id, days
...
<html>
	...
	<body>
		...
		<form action="removeexistingday.php" name="userChoice" method="post" class="setupForm">
			<div class="container">
				<div class="row">
					<div align="center">
						<br>
						<div class="styled-select select">
							<p><b>Remove a day from the booking page:</b></p>
							<?php
								...
								if($row  != null){
								    ...
								    do{
                                        //takes all from the query above and puts into select dropdown
								        unset($id, $days);
								        $id = $row['days'];
								        $days = $row['days']; 
							...
							<?php
								...
								//Note: this should never be reached as a day should always be selected!
