...
if (strstr($_SERVER['HTTP_REFERER'], "usertabletwo.php")) {
...
//selecting all required options
$query     = " 
            SELECT id, days
            FROM daysUsed
            WHERE `$userTable` = 'Yes'
...
<html>
	...
	<body onload="setBanner()">
		...
		<form action="userchoicewithdaytwo.php" name="userChoice" method="post" id="userSubmit">
			<div class="container">
				<div class="row">
					<div align="center">
						<br>
						<div class="styled-select select">
							...
							<?php
								...
								if($row != null){
								    ...
								    do{
                                        //puts all options from the query above into a select dropdown
								        unset($id, $days);
								        $id = $row['days'];
								        $days = $row['days']; 
